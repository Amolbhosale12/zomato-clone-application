...
import Filter from "../Comman/filters";
import {restaurants} from '../../data/restaurants'
import ExploreItems from '../Comman/exploreSection/index';

const restaurantList=restaurants;

// below array contains  object with some details like as id ,cover and title with the help of that details we can make collection component.
  ...
  return (
    <div>
      ...
      <div className="max-width">
        <Filter filterList={diningFilterList}/>
        <ExploreItems list={restaurantList} collectionName="Best Food in Pune"/>
